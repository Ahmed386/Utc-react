...
export default function Home() {
  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-lg-4 backu">
              ...
              <div className=" position-absolute headingtitle ">
                <h1 className="text-white mb-4 mt-1  ">
      ...
      <div
        className="secondsection py-5 px-4 overflow-hidden"
        id="aboutUs"
        ref={aboutRef}
      >
        <div className="container-fluid ">
          <div className="row justify-content-between align-items-center">
            ...
            <motion.div
              className="col-lg-6 col-sm-12 p-4"
              initial={{ opacity: 0, x: 100 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 1.5, delay: 0.3 }}
            >
              <div className=" ">
                <div className="content">
                  ...
                  <p className="text-black-50 contentbreef  ">
                    ...
                    working as main building contractors on all kinds of
              ...
              <SwiperSlide className="p">
                <div className="card mb-3 text-start bg-white px-3  mb-3 shadow ">
                  ...
                  <small className="cardbreef text-black-50">
                    The stage of works which is final, significant and giving
                    the premises its due spender in appearance. Finishing work
                    is very important in the final stages of construction.
                  </small>
                </div>
              </SwiperSlide>
              <SwiperSlide>
              ...
              <SwiperSlide>
                <div className="card mb-3 text-start bg-white px-3  mb-5 shadow ">
                  ...
                  <small className="cardbreef text-black-50">
                    ...
                    technical disciplines encompass the systems that make
                    building interiors suitable for human occupancy.
                  </small>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="card mb-3 text-start bg-white px-3 shadow ">
                  ...
                  <small className="cardbreef text-black-50">
                    ...
                    landscape and create special features.
                  </small>
                </div>
              </SwiperSlide>
            </Swiper>
                  ...
                  <div className="row justify-content-center rowcardwidth">
                    <div className="col-md-6 col-lg-3 cardmargin  ">
                      <div className="card mb-3 text-start bg-white px-3 py-5  mb-3 shadow ">
                        ...
                        <small className="cardbreef text-black-50">
                          ...
                          Finishing work is very important in the final stages
                          of construction.
                        </small>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6 col-lg-3 cardmargin ">
                      <div className="card mb-3 text-start bg-white px-3 py-5 mb-5 shadow ">
                        ...
                        <p className="cardtitle">Landscape</p>
                        <small className="cardbreef text-black-50">
                          Carry out foundational work, such as laying drainage
                          or installing irrigation systems. Also may reshape the
                          landscape and create special features.
                        </small>
                      </div>
                    </div>
